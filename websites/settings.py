...
SECRET_KEY = 'django-insecure-a=t3)ao9k)wsgn#2+c(w3-92w)-78&+k*#f1$+(=^zmii!^kd='
...
STATICFILES_DIRS = [
    BASE_DIR / "static",  # Your static folder in the project root directory
]

# This is only used when collecting static files (e.g., for production deployment)
